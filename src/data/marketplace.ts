...
export const UNSPLASH = {
  ...
  assembly: "photo-1571018400279-7f33252d0ad6",
  tvWall: "photo-1633604712918-6ab1173d0ecd",
  moving: "photo-1714647211902-bb711d643a17",
  cleaning: "photo-1686178827149-6d55c72d81df",
  garden: "photo-1689728318937-17d24bc0a65c",
  repairs: "photo-1772338537689-056082f100a9",
  drill: "photo-1590635023142-73c3d34f2805",
  painting: "photo-1693985120993-e9b203ce7631",
} as const;
...
export const SEARCH_SUGGESTIONS: { id: string; label: string; categorySlug: string }[] = [
  ...
  { id: "s-14", label: "Put up a curtain pole", categorySlug: "home-repairs" },
  { id: "s-15", label: "Assemble flat-pack furniture", categorySlug: "assembly" },
  { id: "s-16", label: "Paint a bedroom", categorySlug: "painting" },
  { id: "s-17", label: "Trim an overgrown hedge", categorySlug: "outdoor-help" },
